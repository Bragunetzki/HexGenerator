...
namespace Editor
{
    ...
    [CustomPropertyDrawer(typeof(SerializableSpeciesDictionary))]
    public class SpeciesDictionaryDrawer : DictionaryDrawer<string, CreatureSpecies> { }
    
    [CustomPropertyDrawer(typeof(SerializablePurposeDictionary))]
    public class PurposeDictionaryDrawer : DictionaryDrawer<string, SitePurpose> { }
}